...
export class UpdateUserWalletSchema1785747121754 implements MigrationInterface {
    name = 'UpdateUserWalletSchema1785747121754'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "utilisateur" ADD CONSTRAINT "UQ_b07debc3c9da23863cf01fe7a90" UNIQUE ("googleId")`);
        await queryRunner.query(`ALTER TABLE "utilisateur" ALTER COLUMN "verificationotp" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "utilisateur" DROP COLUMN "datemodification"`);
        await queryRunner.query(`ALTER TABLE "utilisateur" ADD "datemodification" TIMESTAMP NOT NULL DEFAULT now()`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "utilisateur" DROP COLUMN "datemodification"`);
        await queryRunner.query(`ALTER TABLE "utilisateur" ADD "datemodification" date`);
        await queryRunner.query(`ALTER TABLE "utilisateur" ALTER COLUMN "verificationotp" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "utilisateur" DROP CONSTRAINT "UQ_b07debc3c9da23863cf01fe7a90"`);
