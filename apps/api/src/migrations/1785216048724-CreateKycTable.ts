...
export class CreateKycTable1785216048724 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."kyc_typedocument_enum" AS ENUM('CARTE_IDENTITE', 'PASSEPORT', 'PERMIS_CONDUIRE')`);
        await queryRunner.query(`ALTER TABLE "kyc" ADD "typeDocument" "public"."kyc_typedocument_enum" NOT NULL`);
        await queryRunner.query(`CREATE TYPE "public"."kyc_typejustificatifdomicile_enum" AS ENUM('FACTURE', 'RELEVE_BANCAIRE', 'CERTIFICAT_RESIDENCE')`);
        await queryRunner.query(`ALTER TABLE "kyc" ADD "typeJustificatifDomicile" "public"."kyc_typejustificatifdomicile_enum" NOT NULL`);
        await queryRunner.query(`ALTER TABLE "kyc" ADD "urlRectoDocument" character varying(2048) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "kyc" ADD "urlJustificatifDomicile" character varying(2048) NOT NULL`);
        await queryRunner.query(`CREATE TYPE "public"."kyc_statut_enum" AS ENUM('EN_ATTENTE', 'APPROUVE', 'REJETE')`);
        await queryRunner.query(`ALTER TABLE "kyc" ADD "statut" "public"."kyc_statut_enum" NOT NULL DEFAULT 'EN_ATTENTE'`);
        ...
        await queryRunner.query(`ALTER TABLE "kyc" ADD "creeLe" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "kyc" ADD "misAJourLe" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "kyc" ADD "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "kyc" ADD "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        ...
        await queryRunner.query(`ALTER TABLE "kyc" ADD "status" "public"."kyc_status_enum" NOT NULL DEFAULT 'PENDING'`);
        ...
        await queryRunner.query(`ALTER TABLE "kyc" ADD "proofOfAddressType" "public"."kyc_proofofaddresstype_enum" NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "kyc" ADD "proofOfAddressUrl" character varying(2048) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "kyc" ADD "documentFrontUrl" character varying(2048) NOT NULL`);
        await queryRunner.query(`CREATE TYPE "public"."kyc_documenttype_enum" AS ENUM('NATIONAL_ID', 'PASSPORT', 'DRIVER_LICENSE')`);
        await queryRunner.query(`ALTER TABLE "kyc" ADD "documentType" "public"."kyc_documenttype_enum" NOT NULL`);
    }
