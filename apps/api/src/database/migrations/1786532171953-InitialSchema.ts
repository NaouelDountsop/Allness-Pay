...
export class InitialSchema1786532171953 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."wallets_status_enum" AS ENUM('inactive', 'active', 'suspended', 'closed')`);
        await queryRunner.query(`CREATE TYPE "public"."wallets_type_enum" AS ENUM('PERSONAL', 'TONTINE')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."wallet_transactions_status_enum" AS ENUM('pending', 'completed', 'failed', 'cancelled')`);
        ...
        await queryRunner.query(`ALTER TABLE "tontines" ADD CONSTRAINT "FK_e85a0014a2e0f40307d7db34d24" FOREIGN KEY ("creatorId") REFERENCES "utilisateur"("idutilisateur") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tontines" DROP CONSTRAINT "FK_e85a0014a2e0f40307d7db34d24"`);
