...
export class InitialSchema1786532171953 implements MigrationInterface {
  name = 'InitialSchema1786532171953';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."wallets_status_enum" AS ENUM('inactive', 'active', 'suspended', 'closed')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."wallets_type_enum" AS ENUM('PERSONAL', 'TONTINE')`,
    );
    await queryRunner.query(
      `CREATE TABLE "wallets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "walletNumber" character varying NOT NULL, "userId" integer NOT NULL, "balance" bigint NOT NULL DEFAULT '0', "currency" character varying NOT NULL DEFAULT 'XAF', "status" "public"."wallets_status_enum" NOT NULL DEFAULT 'inactive', "type" "public"."wallets_type_enum" NOT NULL DEFAULT 'PERSONAL', "tontineid" uuid, "isPrimary" boolean NOT NULL DEFAULT false, "label" character varying, "pinHash" character varying, "pinCreatedAt" TIMESTAMP, "failedPinAttempts" integer NOT NULL DEFAULT '0', "lockedUntil" TIMESTAMP, "version" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_4f18b2dd66fee782bd5acbab08f" UNIQUE ("walletNumber"), CONSTRAINT "PK_8402e5df5a30a229380e83e4f7e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "wallet_transactions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "walletId" uuid NOT NULL, "type" "public"."wallet_transactions_type_enum" NOT NULL, "amount" bigint NOT NULL, "relatedWalletId" uuid, "reference" character varying, "provider" character varying, "providerRequestId" character varying, "providerTransactionId" character varying, "operator" "public"."wallet_transactions_operator_enum", "phoneNumber" character varying, "description" text, "status" "public"."wallet_transactions_status_enum" NOT NULL DEFAULT 'completed', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_5120f131bde2cda940ec1a621db" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."linked_accounts_type_enum" AS ENUM('bank_account', 'mobile_money')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."linked_accounts_operator_enum" AS ENUM('mtn_momo', 'orange_money', 'wave', 'free_money', 'moov_money', 'airtel_money', 'bank_app', 'other')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."linked_accounts_status_enum" AS ENUM('pending', 'active', 'suspended', 'removed')`,
    );
    await queryRunner.query(
      `CREATE TABLE "linked_accounts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" integer NOT NULL, "walletId" uuid NOT NULL, "type" "public"."linked_accounts_type_enum" NOT NULL, "operator" "public"."linked_accounts_operator_enum" NOT NULL, "label" character varying(100) NOT NULL, "phoneNumber" character varying(50), "accountNumber" character varying(50), "bankName" character varying(100), "iban" character varying(50), "swiftCode" character varying(20), "currency" character varying(20) NOT NULL DEFAULT 'XAF', "status" "public"."linked_accounts_status_enum" NOT NULL DEFAULT 'pending', "isDefault" boolean NOT NULL DEFAULT false, "verificationToken" text, "verifiedAt" TIMESTAMP, "failedVerificationAttempts" integer NOT NULL DEFAULT '0', "lockedUntil" TIMESTAMP, "externalAccountId" character varying(255), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_445bf7a50aeeb7f0084052935a6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."kyc_identitydocumenttype_enum" AS ENUM('NATIONAL_ID', 'PASSPORT', 'DRIVER_LICENSE')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tontines" ADD CONSTRAINT "FK_e85a0014a2e0f40307d7db34d24" FOREIGN KEY ("creatorId") REFERENCES "utilisateur"("idutilisateur") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tontines" DROP CONSTRAINT "FK_e85a0014a2e0f40307d7db34d24"`,
    );
    await queryRunner.query(
