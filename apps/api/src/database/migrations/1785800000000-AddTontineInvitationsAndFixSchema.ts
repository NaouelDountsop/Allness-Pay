...
export class AddTontineInvitationsAndFixSchema1785800000000 implements MigrationInterface {
  ...
  private async addColumnIfNotExists(queryRunner: QueryRunner, table: string, column: string, definition: string) {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "tontines" ALTER COLUMN "frequence" TYPE character varying`);
    await queryRunner.query(`DROP TYPE IF EXISTS "public"."tontine_frequency_enum" CASCADE`);
    await queryRunner.query(`CREATE TYPE "public"."tontine_frequency_enum" AS ENUM('Hebdomadaire', 'Bimensuelle', 'Mensuelle')`);
    await queryRunner.query(`ALTER TABLE "tontines" ALTER COLUMN "frequence" TYPE "public"."tontine_frequency_enum" USING "frequence"::"public"."tontine_frequency_enum"`);
    await queryRunner.query(`ALTER TABLE "tontines" ALTER COLUMN "frequence" SET DEFAULT 'Mensuelle'`);
    ...
    await queryRunner.query(`CREATE TYPE "public"."tontine_status_enum" AS ENUM('DRAFT', 'ACTIVE', 'CLOSED')`);
    await queryRunner.query(`ALTER TABLE "tontines" ALTER COLUMN "statut" TYPE "public"."tontine_status_enum" USING UPPER("statut")::"public"."tontine_status_enum"`);
    ...
    await this.addColumnIfNotExists(queryRunner, 'tontine_members', 'role', "character varying NOT NULL DEFAULT 'MEMBER'");
    await this.addColumnIfNotExists(queryRunner, 'tontine_members', 'status', "character varying NOT NULL DEFAULT 'ACTIVE'");
    await this.addColumnIfNotExists(queryRunner, 'tontine_members', 'beneficiaryOrder', 'integer');
    await this.addColumnIfNotExists(queryRunner, 'tontine_members', 'hasReceivedPayout', 'boolean NOT NULL DEFAULT false');
    await this.addColumnIfNotExists(queryRunner, 'tontine_members', 'missedContributions', 'integer NOT NULL DEFAULT 0');
    ...
    if (invExists.length === 0) {
      ...
      await queryRunner.query(`
        ...
        ON DELETE CASCADE
      `);
      await queryRunner.query(`CREATE INDEX "IDX_tontine_invitations_tontineId" ON "tontine_invitations" ("tontineId")`);
      await queryRunner.query(`CREATE INDEX "IDX_tontine_invitations_inviteeEmail" ON "tontine_invitations" ("inviteeEmail")`);
      await queryRunner.query(`CREATE INDEX "IDX_tontine_invitations_token" ON "tontine_invitations" ("token")`);
    }
    ...
    if (cycExists.length === 0) {
      ...
      await queryRunner.query(`
        ...
        ON DELETE CASCADE
      `);
      await queryRunner.query(`CREATE INDEX "IDX_tontine_cycles_tontineId" ON "tontine_cycles" ("tontineId")`);
    }
    ...
    if (contExists.length === 0) {
      ...
      await queryRunner.query(`
        ...
        ON DELETE CASCADE
      `);
      await queryRunner.query(`CREATE INDEX "IDX_tontine_contributions_cycleId" ON "tontine_contributions" ("cycleId")`);
    }
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "tontine_members" DROP COLUMN IF EXISTS "missedContributions"`);
    await queryRunner.query(`ALTER TABLE "tontine_members" DROP COLUMN IF EXISTS "hasReceivedPayout"`);
    await queryRunner.query(`ALTER TABLE "tontine_members" DROP COLUMN IF EXISTS "beneficiaryOrder"`);
    ...
    await queryRunner.query(`ALTER TABLE "tontines" ALTER COLUMN "statut" TYPE "public"."tontine_status_enum" USING LOWER("statut")::"public"."tontine_status_enum"`);
