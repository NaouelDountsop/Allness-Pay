...
export class CampayWithdrawDto {
  @ApiProperty({
    ...
    description: 'Numéro du wallet à débiter, format WLT + 10 chiffres',
  })
  @IsString()
  ...
  @ApiProperty({
    example: '5000',
    description: 'Montant à retirer en XAF (nombre positif, 2 décimales max)',
  })
  @IsString()
  ...
  @ApiPropertyOptional({
    example: 'a2707130-2419-441e-95b8-1bddefc2cbfb',
    description: 'Référence UUID4 unique pour l\'idempotence (optionnel)',
  })
  @IsOptional()
  @IsString()
  @Length(1, 255)
