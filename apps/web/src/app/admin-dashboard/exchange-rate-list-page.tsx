...
const RATES: Rate[] = [
  { id: "1", base: "EUR", baseLabel: "Euro", baseFlag: "🇪🇺", target: "XAF", targetLabel: "Franc CFA", targetFlag: "🌍", rate: "655,9578", change: "+0,45%", isUp: true, source: "Banque Centrale", mode: "Automatique", updatedAt: "08:45", status: "Actif" },
  { id: "2", base: "USD", baseLabel: "Dollar US", baseFlag: "🇺🇸", target: "XAF", targetLabel: "Franc CFA", targetFlag: "🌍", rate: "603,2500", change: "-0,12%", isUp: false, source: "Banque Centrale", mode: "Automatique", updatedAt: "08:45", status: "Actif" },
  { id: "3", base: "GBP", baseLabel: "Livre Sterling", baseFlag: "🇬🇧", target: "XAF", targetLabel: "Franc CFA", targetFlag: "🌍", rate: "787,6543", change: "+0,32%", isUp: true, source: "API Forex", mode: "Automatique", updatedAt: "08:45", status: "Actif" },
  { id: "4", base: "EUR", baseLabel: "Euro", baseFlag: "🇪🇺", target: "USD", targetLabel: "Dollar US", targetFlag: "🇺🇸", rate: "1,0876", change: "+0,18%", isUp: true, source: "API Forex", mode: "Automatique", updatedAt: "08:45", status: "Actif" },
  { id: "5", base: "USD", baseLabel: "Dollar US", baseFlag: "🇺🇸", target: "EUR", targetLabel: "Euro", targetFlag: "🇪🇺", rate: "0,9194", change: "-0,20%", isUp: false, source: "API Forex", mode: "Automatique", updatedAt: "08:45", status: "Actif" },
  { id: "6", base: "XAF", baseLabel: "Franc CFA", baseFlag: "🌍", target: "NGN", targetLabel: "Naira", targetFlag: "🇳🇬", rate: "2,5789", change: "+0,78%", isUp: true, source: "Manuel", mode: "Manuel", updatedAt: "07:30", status: "Actif" },
  { id: "7", base: "XAF", baseLabel: "Franc CFA", baseFlag: "🌍", target: "GHS", targetLabel: "Cedi", targetFlag: "🇬🇭", rate: "3,1254", change: "+0,15%", isUp: true, source: "API Forex", mode: "Automatique", updatedAt: "08:45", status: "Actif" },
  { id: "8", base: "XAF", baseLabel: "Franc CFA", baseFlag: "🌍", target: "USD", targetLabel: "Dollar US", targetFlag: "🇺🇸", rate: "0,001658", change: "-0,10%", isUp: false, source: "Banque Centrale", mode: "Automatique", updatedAt: "08:45", status: "Actif" },
];
