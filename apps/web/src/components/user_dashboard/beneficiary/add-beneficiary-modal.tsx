...
} from "@/lib/api/beneficiary.service";
        ...
        {step === 2 && (
          <div className="space-y-3 bg-gray-50 p-4 rounded-xl text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium">{selectedCountry.dialCode} {phone}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500">Réseau</span>
              <span className="font-medium">{NETWORKS.find((n) => n.value === network)?.label}</span>
            </div>
            <div className="flex justify-between">
