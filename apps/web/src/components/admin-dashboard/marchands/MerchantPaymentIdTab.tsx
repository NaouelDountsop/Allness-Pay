      ...
      <SectionCard title="Paiement par Identifiant">
        <div className="flex flex-col items-center py-8">
          ...
          <div className="flex items-center gap-3 mb-4">
            <p className="text-2xl font-bold tracking-widest text-afrilink-dark">MER-88219</p>
            <button
              className="w-8 h-8 rounded-lg border border-gray-200 flex items-center justify-center text-gray-400 hover:text-afrilink-dark"
              aria-label="Copier"
            >
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-3 border border-gray-100 rounded-lg px-4 py-3">
            <span className="w-9 h-9 rounded-lg bg-green-50 flex items-center justify-center">
              <Hash className="w-4 h-4 text-afrilink-green" />
            </span>
            <div>
              <p className="text-xs font-medium text-afrilink-dark">Numéro Marchand</p>
          ...
          <div className="flex items-center gap-3 border border-gray-100 rounded-lg px-4 py-3">
            <span className="w-9 h-9 rounded-lg bg-orange-50 flex items-center justify-center">
              <Smartphone className="w-4 h-4 text-afrilink-orange" />
            </span>
            <div>
              <p className="text-xs font-medium text-afrilink-dark">Code USSD</p>
