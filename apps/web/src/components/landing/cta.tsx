...
export default function CTA() {
  return (
    <section className="bg-afrilink-dark text-white py-16 lg:py-24 relative overflow-hidden">
      <div className="absolute -right-10 top-1/2 -translate-y-1/2 opacity-20">
        <Plane className="h-48 w-48 text-afrilink-orange -rotate-12" strokeWidth={1} />
      </div>
