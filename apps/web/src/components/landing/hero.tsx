        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-10 items-center">
          <div className="animate-fade-up">
            ...
            <div className="mt-7 flex items-center gap-2 text-sm text-white/80">
              <span className="flex h-6 w-6 items-center justify-center rounded-full bg-afrilink-green animate-pulse-glow">
          ...
          <div className="relative animate-fade-up" style={{ animationDelay: '150ms' }}>
            <div className="relative mx-auto max-w-md">
              ...
              <div className="absolute -bottom-2 -left-4 lg:-left-10 w-56 bg-white text-afrilink-dark rounded-2xl shadow-2xl p-4 animate-float-slow">
