    ...
    <footer id="contact" className="bg-afrilink-dark text-white">
      <div className="mx-auto max-w-7xl px-5 lg:px-8 py-14 lg:py-16">
        <div className="grid md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-sm text-white/60 max-w-xs leading-relaxed">
              Votre patrimoine global, simplifié. Transferts, tontines et paiement de services en
              toute sécurité.
            </p>
        ...
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3">
          <span className="text-xs text-white/50">© 2026 AfriLink Pay. Tous droits réservés.</span>
