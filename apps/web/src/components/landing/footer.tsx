...
const SOCIAL_LINKS = [
  ...
  {
    name: 'Facebook',
    href: 'https://facebook.com/allnesspay',
    icon: (
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/company/allnesspay',
    icon: (
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Twitter',
    href: 'https://twitter.com/allnesspay',
    icon: (
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Instagram',
    href: 'https://instagram.com/allnesspay',
    icon: (
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    <footer id="contact" className="bg-allness-dark dark:bg-[#061216] text-white">
      <div className="mx-auto max-w-7xl px-5 lg:px-8 py-14 lg:py-16">
        ...
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3">
          <span className="text-xs text-white/50">© 2026 Allness Pay. Tous droits réservés.</span>
